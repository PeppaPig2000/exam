...
export const Nav10DataSource = {
    ...
    Menu: {
        ...
        children: [
            ...
            {name: 'item1', a: {children: '我的考试', href: '/myexam'}},
            // {name: 'item2', a: {children: '试题列表', href: '/topiclist'}},
            // {name: 'item3', a: {children: '自我检测', href: '/selfexam'}},
            {name: 'item4', a: {children: '个人信息', href: '/inform'}},
